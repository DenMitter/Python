...
action = int(input('Що робимо ( множити 1 | відняти 2 | додати 3): '))
...
if action == 1: print(f'Результат: {num_one * num_two}')
    ...
    if num_one == num_two: print(f'Результат: {num_one} = {num_two}')
    else: print(f'Результат: числа не рівні, виберіть іншу дію або введіть другі числа')